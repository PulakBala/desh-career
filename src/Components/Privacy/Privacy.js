    ...
    <div className="container">
      <div className="privacy-policy">
        ...
        <p>
          ...
          accessible from <br />
          <a href="www.deshcareer.com">www.deshcareer.com</a>
          <br />
          <br />
          <br />
        </p>
        ...
        <ul>
          <li>
            To comply with a legal obligation To protect against legal liability
          </li>
          <li>
            To protect and defend the rights or property of <a href="#">Bangla</a>{" "}
            Puzzle
          </li>
          <li>
...
<br/>
<br/>
If you have any questions about this Privacy Policy, please contact us: contact.deshcareer@gmail.com</p>
      </div>
    </div>
  );
};
